...
Since the public variables $\mathbf{\hat p}_b$, $\mathbf{\hat q}_b$ and
...
of \baheem's private variables below $\entropy(\mathbf{k})$.
...
\begin{lstlisting}[language=C, caption=Encryption function example.,
                   label=lst_baheem_c_enc,captionpos=b]
void baheem_enc(
...
\begin{lstlisting}[language=C, caption=Decryption funciton example.,
                   label=lst_baheem_c_dec,captionpos=b]
